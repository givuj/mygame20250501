...
public class RetreatAfterAttactState : State<EnemyController>
{
    ...
    {
        if(Vector3.Distance(enemy.Target.transform.position, enemy.transform.position)>=distanceToRetreat)
        {
